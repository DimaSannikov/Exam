...
* Создадим метод "CheckElementsInArray" который принимает массив и проверяет длину каждого элемента 
* Создаем метод "MakeNewArray" который создает новый массив и "записывает" элементы в него
